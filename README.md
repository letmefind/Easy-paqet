...
> **⚠️ نکته:** اگر حروف فارسی در terminal برعکس نمایش داده می‌شن، این مشکل از terminal شماست نه از اسکریپت. برای راه حل، فایل [TERMINAL_FIX.md](TERMINAL_FIX.md) رو بخون.
